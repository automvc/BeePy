...
class Clazz:
    ...
    __joins__ = {
        ...
        "clazz_place": JoinTable(
           ...
           "sch_district": JoinTable(
            sub_class = Sch_district,
            joinType = JoinType.JOIN,
            main_fields = ["sch_district_id"],
            sub_fields = ["id"],
        )
    }
...
if __name__ == '__main__':
    ...
    #subclass_condition
    clazz_place=Clazz_place()
    clazz_place.place='floor1'
    clazz.clazz_place=clazz_place
    
    student=Student()
    student.id=20011
    student_list=[student]
    clazz.student_list=student_list
