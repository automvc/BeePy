...
if __name__ == '__main__':  
    try:  
        ...
        excluding={'exam\\ExceptionTest.py','exam\\hello.py','test_all_3.8.py'}
        
        scripts = [
        f for f in scripts   
        if not (f.startswith('entity\\') or f.endswith('test_all.py') or f.endswith('__init__.py') or f.endswith('.pyc') or f in excluding)  
        ]  
